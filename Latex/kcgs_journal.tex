...
%% 1. If you use KC2006 instead of MikTeX, use ``dhucs'' package and 
%%    comment out the command "\kscntformat{section}{}{.}".
...
%% This file is tested under KC2006 and MikTex 2.4~2.5 with HLaTeX.
%%
%% If you have problems in using LaTeX, visit this site: http://www.ktug.or.kr
%%
...
\usepackage{geometry}
\geometry{hmargin={1cm, 1cm}, vmargin={3cm, 2cm}}
...
%% to bring the sans-serif type in line with th4e serif type.
...
%% You don't have to use this package if the package dose not exist.
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item[-] 그림의 명칭은 하단에, 표는 상단에 각각 그림 1 및 표 1로 표기한다.
	\end{itemize}
	\item 참고문헌
	\begin{itemize}
